 ...
 * Tell：15006330640
 */
public class Mail_Select_Activity extends Activity implements ExpandableListView.OnChildClickListener {
    ...
    private void initConstants() {
        context = Mail_Select_Activity.this;
    }
...
//                }
                ...
                Mail_Select_Activity.this.setResult(RESULT_OK, intent);
                Mail_Select_Activity.this.finish();
            }
        });
        // 取消
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (address != null) {
                    ...
                    for (int i = 0; i < departs.size(); i++) {
                        ...
                        ArrayList<Map<String, Boolean>> childCB = new ArrayList<>();

 ...
 * Time: 17:14
 */
public class Attendance_Approver_Adapter3 extends BaseAdapter {

    private LayoutInflater mIayoutInflater;
    private Context mContext;
    private AttendanceApprover3 approver= new AttendanceApprover3();
...
//    private List<AttendanceApprover2.DataEntity.UserEntity> userList=new ArrayList<>();
    private List<AttendanceApprover3.DataEntity.UseridEntity> userList=new ArrayList<>();
    HashMap<String, Boolean> status = new HashMap<String, Boolean>();

    public Attendance_Approver_Adapter3(Context context, List<AttendanceApprover3.DataEntity.UseridEntity> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final AttendanceApprover3.DataEntity.UseridEntity userObject = userList.get(position);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Attendance_Approver_Adapter3.this.notifyDataSetChanged();
            }
        });

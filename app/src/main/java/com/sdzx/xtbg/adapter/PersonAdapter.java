...
public class PersonAdapter extends BaseAdapter {
     ...
     * 数据集合
     */
    private List<Person_User> datas = null;
    ...
    public PersonAdapter(Context context, List<Person_User> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Person_User bean = datas.get(position);
     ...
     * 增加一项的时候
     */
    public void add(Person_User bean) {
    ...
    public List<Person_User> getDatas() {
        return datas;
    }

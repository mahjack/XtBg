 ...
 * Time: 17:14
 */
public class Attendance_Approver_Adapter extends BaseAdapter {
    ...
    public Attendance_Approver_Adapter(Context context, List<AttendanceApprover.User> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final AttendanceApprover.User userObject = userList.get(position);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Attendance_Approver_Adapter.this.notifyDataSetChanged();
            }
        });

 ...
 * Tell：15006330640
 */
public class Send_Document_Process_Adapter extends BaseAdapter {
    private Context context;
    private List<SendDocDetails.Value1> value;

    public Send_Document_Process_Adapter(Context context, List<SendDocDetails.Value1> value) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SendDocDetails.Value1 value3 = value.get(position);

 ...
 * Time: 17:14
 */
public class Attendance_Audit_Adapter extends BaseAdapter {

    private Context mContext;
    private AttendanceAudit audit = new AttendanceAudit();
    private List<AttendanceAudit.User> userList = new ArrayList<>();

    HashMap<String, Boolean> status = new HashMap<String, Boolean>();

    public Attendance_Audit_Adapter(Context context, List<AttendanceAudit.User> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final AttendanceAudit.User userObject = userList.get(position);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Attendance_Audit_Adapter.this.notifyDataSetChanged();
            }
        });

...
public class SendDocDetailReceiverAdapter extends BaseAdapter {
     ...
     * 数据集合
     */
    private List<SendDocApprove.UserID> datas = null;
    ...
    public SendDocDetailReceiverAdapter(Context context, List<SendDocApprove.UserID> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        SendDocApprove.UserID bean = datas.get(position);
...
//        boolean canRemove = bean.isCanRemove();
        ...
        tvTitle.setText(bean.getRealname());
     ...
     * 增加一项的时候
     */
    public void add(SendDocApprove.UserID bean) {
    ...
    public List<SendDocApprove.UserID> getDatas() {
        return datas;
    }
